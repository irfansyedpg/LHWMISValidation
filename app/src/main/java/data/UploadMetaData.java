 ...
 */
public class UploadMetaData extends AsyncTask {
    ...
    public UploadMetaData(Context context) {
    ...
    protected void onPreExecute() {
        ...
        String query = "select * from TableMetadata where LHWSectionId='" + Global.global_id + "'";
        ...
        if (c != null && c.getCount() != 0) {
            if (c.moveToFirst()) {
                ...
                do {
                    ...
                    if (ccc == Global.loop_Increment) {
                        ...
                        param.put("user", c.getString(c.getColumnIndex("user")));
                        param.put("appversion", c.getString(c.getColumnIndex("appversion")));
                        param.put("gpslat", c.getString(c.getColumnIndex("gpslat")));
                        param.put("gpslng", c.getString(c.getColumnIndex("gpslng")));
                        param.put("datetimeInterview", c.getString(c.getColumnIndex("datetimeInterview")));

                        param.put("LHWSectionId", Global.server_id);
            ...
            param.put("user", "00");
            param.put("appversion", "00");
            param.put("gpslat", "00");
            param.put("gpslng", "00");
            param.put("datetimeInterview", "00");
            param.put("LHWSectionId", Global.server_id);
    ...
    protected Object doInBackground(Object[] objects) {
        ...
        String urlString = new MyPreferences(mContext).getReq3()+"InsertMetaData";
