...
public class PendingInterviewsVHC extends AppCompatActivity {
...
class  PendingInterviewsVHCCustomAdapter extends RecyclerView.Adapter{

    Context mContext;
    List<String> mList;
    public PendingInterviewsVHCCustomAdapter(Context context, List<String> list){
        mContext = context;
        mList = list;
    }
            ...
            public void onClick(View view) {
                ...
                b.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                     ...
                     //   intent = new Intent(this, PendingInterviewsVHC.class);
                    }
                }).show();
            }
        });
