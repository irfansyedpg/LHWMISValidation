...
public class pendinginterviews extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new pendinginterviewsCustomAdapter(this, list);
...
class  pendinginterviewsCustomAdapter extends RecyclerView.Adapter{

    Context mContext;
    List<String> mList;
    public pendinginterviewsCustomAdapter(Context context, List<String> list){
        mContext = context;
        mList = list;
    }
